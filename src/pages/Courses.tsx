  ...
  return (
    <div className="min-h-screen bg-neutral-50 py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold mb-8 text-primary">课程中心</h1>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="搜索课程..."
                  className="w-full pl-10 pr-4 py-2 border border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-secondary"
                  value={searchTerm}
            ...
            <div className="flex gap-4">
              <div>
                ...
                <select
                  className="border border-neutral-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-secondary"
                  value={category}
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    <span className={`px-2 py-1 rounded text-xs font-medium ${course.difficulty === 'beginner' ? 'bg-accent/10 text-accent' : course.difficulty === 'intermediate' ? 'bg-secondary/10 text-secondary' : 'bg-primary/10 text-primary'}`}>
                      {course.difficulty === 'beginner' ? '初级' : course.difficulty === 'intermediate' ? '中级' : '高级'}
                    </span>
                    <span className="mx-2 text-neutral-400">•</span>
                    <span className="text-neutral-600 text-sm">{course.duration} 小时</span>
                  </div>
        ...
        {!isLoading && filteredCourses.length === 0 && (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-primary">未找到课程</h3>
            <p className="text-neutral-600">尝试调整搜索条件或筛选选项</p>
          </div>
        )}
      </div>
    </div>
